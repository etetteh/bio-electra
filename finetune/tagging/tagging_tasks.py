...
class BC5C(TaggingTask):
  ...
  def __init__(self, config, tokenizer):
    super(BC5C, self).__init__(config, "bc5cdr-chem", tokenizer, is_token_level=False)
    
    
class BC5D(TaggingTask):
  """Entity-level text chunking."""
  def __init__(self, config, tokenizer):
    super(BC5D, self).__init__(config, "bc5cdr-disease", tokenizer, is_token_level=False)


class NCBI(TaggingTask):
  """Entity-level text chunking."""
  def __init__(self, config, tokenizer):
    super(NCBI, self).__init__(config, "ncbi-disease", tokenizer, is_token_level=False)


class BC2GM(TaggingTask):
  """Entity-level text chunking."""
  def __init__(self, config, tokenizer):
    super(BC2GM, self).__init__(config, "bc2gm", tokenizer, is_token_level=False)


class BC4D(TaggingTask):
  """Entity-level text chunking."""
  def __init__(self, config, tokenizer):
    super(BC4D, self).__init__(config, "bc4chemd", tokenizer, is_token_level=False)
    
    
class JNLPBA(TaggingTask):
  """Entity-level text chunking."""
  def __init__(self, config, tokenizer):
    super(JNLPBA, self).__init__(config, "jnlpba", tokenizer, is_token_level=False)
    
    
class LINNAEUS(TaggingTask):
  """Entity-level text chunking."""
  def __init__(self, config, tokenizer):
    super(LINNAEUS, self).__init__(config, "linnaeus", tokenizer, is_token_level=False)
    

class S800(TaggingTask):
  """Entity-level text chunking."""
  def __init__(self, config, tokenizer):
    super(S800, self).__init__(config, "s800", tokenizer, is_token_level=False)
